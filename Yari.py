...
def main():
	...
	print("\033[1;92m\t│\033[1;92mWELLCOME TO YARI🙈 0.1     \033[1;92m      │")
	...
	if Adi in ('0', '00'):
		...
		exit('THANKS FOR USING YARI TOOL')  
...
class __crack__:
	...
	def __pler__(self):
		...
		print ("\033[1;37m [1] \033[1;36mMETHOD 1 new  ")

		print ("\033[1;37m [2] \033[1;36mMETHOD 2 odl ")

		print ("\033[1;37m [3] \033[1;36mMETHOD 2 odl ")
...
=================================================
    ...
    [-] AUTHOR    :\033[1;32m Yari

    [-] GITHUB    :\033[1;32m Shoaibkhattak567

    [-] WhatsApp  :\033[1;32m 03434131704

    [-] TOOLS     :\033[1;32m FILE

    [-] VERSION   :\033[1;32m 0.1

    [-] STATUS    :\033[1;32m Free

    [-] BEST YAR SUDAIS X SHOAIB 
